...
Class PurchOrder {
	...
	function update_order_item($LineNo,
			...
			$this->LineItems[$LineNo]->Price = $Price;
                        $this->LineItems[$LineNo]->VersionReference = $VersionReference;
	}
...
/* PurchOrderDetails */
	...
	function LineDetails ($LineNo, $StockItem, $Controlled, $Serialised, $Qty, $ItemDescr,  $VersionReference, $Prc, $UOM, $GLCode, $ReqDelDate, $ShiptRef, $JobRef, $QtyInv, $QtyRecd, $GLActName, $DecimalPlaces){
