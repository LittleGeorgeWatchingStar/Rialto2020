...
Class SpecialOrder {
	...
	function add_to_order($LineNo, $Qty, $ItemDescr, $VersionReference, $Price, $Cost, $StkCat, $ReqDelDate){
		if ($Qty!=0 && isset($Qty)){
			$this->LineItems[$LineNo] = new LineDetails($LineNo, $Qty, $ItemDescr, $VersionReference, $Price, $Cost, $StkCat, $ReqDelDate);
			$this->LinesOnOrder++;
			Return 1;
		}
		Return 0;
...
Class LineDetails {
	...
	function LineDetails ($LineNo, $Qty, $ItemDescr, $Price, $Cost, $StkCat, $ReqDelDate, $Version=''){
