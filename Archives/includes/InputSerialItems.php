...
/*
        Entry Types:
             ...
             Barcode Mode: Part Keyed, part not. 1st, 'Qty' of barcodes entered.
             Then extra data as necessary
             FileUpload Mode: File Uploaded must fulfill item requirements when
                parsed... no form based data entry. 1-upload, 2-parse&validate,
                3-bad>1 good>4, 4-import.
...
$EditLink =  '<A HREF="' . $_SERVER['PHP_SELF'] . '?' . SID . 'EditControlled=true&StockID=' . $LineItem->StockID .
...
if ($LineItem->Serialised==1){
	...
	$tableheader = '<TR>
			<TD class=tableheader>'. _('ReelID'). '</TD>
			<TD class=tableheader>'. _('Quantity'). '</TD>
                        <TD class=tableheader>'. _('Bin format'). '</TD>
