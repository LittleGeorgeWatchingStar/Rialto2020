...
/*Set up the variables that will be needed in construction of the EDI message */
		...
		$BranchStreet1 = $TransDetails['BrAddr1'];
		$BranchStreet2 = $TransDetails['BrAddr2'];
		$BranchMailStop = $TransDetails['BrMailStop'];
		$BranchCity = $TransDetails['BrCity'];
		$BranchState = $TransDetails['BrState'];
		$BranchZip = $TransDetails['BrZip'];
		$BranchCountry = $TransDetails['BrCountry'];
