...
if (!isset($_GET['delete'])) {
	...
	if ($_POST['Calculation']==0){ /*Its not a calculated column */
		echo '<TR><TD>' . _('From Period') . ':</TD><TD><INPUT TYPE="TEXT" size=4 maxlength=3 name="PeriodFrom" value=' . $_POST['PeriodFrom'] . '>  <a target="_blank" href="/index.php/record/Accounting/Period/">' . _('View Periods') . '</a></TD></TR>';
