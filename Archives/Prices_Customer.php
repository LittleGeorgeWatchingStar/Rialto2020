...
$result = DB_query("	SELECT Name,CurrCode,SalesType  FROM  DebtorsMaster
			WHERE DebtorNo='" . $_SESSION['CustomerID'] . "'",$db);
...
$sql = "SELECT Prices.Price,
	...
	AND Prices.CurrAbrev='$CurrCode'
	AND (CustBranch.DebtorNo='" . $_SESSION['CustomerID'] . "' OR CustBranch.DebtorNo IS NULL)";
if ($Item != 'ALL') {
	$sql .= "        AND Prices.StockID='$Item' ";
}
