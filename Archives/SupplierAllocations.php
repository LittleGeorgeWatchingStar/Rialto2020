...
/*
	...
	The page will then show potential allocations for the transaction called
    with, this page can be called from the supplier enquiry to show the make up
    and to modify existing allocations

	2. A SupplierID
	The page will show all outstanding payments or credits yet to be allocated
    for the supplier selected

	3. No parameters
	The page will show all outstanding supplier credit notes and payments yet
    to be allocated
*/
...
if (isset($_POST['AllocTrans'])) {
    ...
    if ($_SESSION['Alloc']->TransExRate != 1) {
        ...
        echo '<BR>' . _('Transaction total') . ': <B>' . -$_SESSION['Alloc']->TransAmt . '</B></font>';
    }
