...
use Rialto\SalesBundle\Entity\HoldReason;
use Rialto\GeographyBundle\Model\Country;
use Rialto\AccountingBundle\Entity\PaymentTerms;$PageSecurity=15;
...
/*Now check that the new code doesn't already exist */
	...
	$sql = "INSERT INTO DebtorsMaster (`DebtorNo`, `Name`, `Addr1`, `Addr2`, `MailStop`, `City`, `State`, `Zip`, `Country`, `CurrCode`, `SalesType`, `ClientSince`, `HoldReason`, `PaymentTerms`, `Discount`, `DiscountCode`, `PymtDiscount`, `LastPaid`, `LastPaidDate`, `CreditLimit`, `InvAddrBranch`, `EDIInvoices`, `EDIOrders`, `EDIReference`, `EDITransport`, `EDIAddress`, `EDIServerUser`, `EDIServerPwd`) SELECT '" . $_POST['NewDebtorNo'] . "', `Name`, `Addr1`, `Addr2`, `MailStop`, `City`, `State`, `Zip`, `Country`, `CurrCode`, `SalesType`, `ClientSince`, `HoldReason`, `PaymentTerms`, `Discount`, `DiscountCode`, `PymtDiscount`, `LastPaid`, `LastPaidDate`, `CreditLimit`, `InvAddrBranch`, `EDIInvoices`, `EDIOrders`, `EDIReference`, `EDITransport`, `EDIAddress`, `EDIServerUser`, `EDIServerPwd` FROM DebtorsMaster WHERE DebtorNo='" . $_POST['OldDebtorNo'] . "'";
	...
	$sql = "INSERT INTO CustBranch ( `BranchCode`, `DebtorNo`, `BrName`, `BrAddr1`, `BrAddr2`, `BrMailStop`, `BrCity`, `BrState`, `BrZip`, `BrCountry`, `EstDeliveryDays`, `Area`, `Salesman`, `FwdDate`, `PhoneNo`, `FaxNo`, `ContactName`, `Email`, `DefaultLocation`, `TaxAuthority`, `DisableTrans`, `BrPostAddr1`, `BrPostAddr2`, `BrPostMailStop`, `BrPostCity`, `BrPostState`, `BrPostZip`, `BrPostCountry`, `DefaultShipVia`, `CustBranchCode`) SELECT BranchCode, '" . $_POST['NewDebtorNo'] . "', `BrName`, `BrAddr1`, `BrAddr2`, `BrMailStop`, `BrCity`, `BrState`, `BrZip`, `BrCountry`, `EstDeliveryDays`, `Area`, `Salesman`, `FwdDate`, `PhoneNo`, `FaxNo`, `ContactName`, `Email`, `DefaultLocation`, `TaxAuthority`, `DisableTrans`, `BrPostAddr1`, `BrPostAddr2`, `BrPostMailStop`, `BrPostCity`, `BrPostState`, `BrPostZip`, `BrPostCountry`, `DefaultShipVia`, `CustBranchCode` FROM CustBranch WHERE DebtorNo='" . $_POST['OldDebtorNo'] . "'";
