...
if (isset($_POST['PrintPDF'])){
	...
	While ($Customers = DB_fetch_array($CustomersResult,$db)){
		...
		if ($PrintThisCustomer){
			...
			$LeftOvers = $pdf->addTextWrap(80,$YPos-10,150,$FontSize,$Customers['Addr1']);
			$LeftOvers = $pdf->addTextWrap(80,$YPos-20,150,$FontSize,$Customers['Addr2']);
			$LeftOvers = $pdf->addTextWrap(80,$YPos-30,150,$FontSize,$Customers['City'].','.$Customers['State'].' '.$Customers['Zip'].' '.$Customers['Country']);
			...
			$LeftOvers = $pdf->addTextWrap(440,$YPos,150,$FontSize,$Customers['BrAddr1']);
			$LeftOvers = $pdf->addTextWrap(440,$YPos-10,150,$FontSize,$Customers['BrAddr2']);
			$LeftOvers = $pdf->addTextWrap(440,$YPos-20,150,$FontSize,$Customers['BrCity'].','.$Customers['BrState'].' '.$Customers['BrZip'].' '.$Customers['BrCountry']);
