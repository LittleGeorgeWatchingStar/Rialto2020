...
#my $weberpdb = DBI->connect('dbi:mysql:erp_gum:localhost','gordon','baldw1n', { PrintError => 1, RaiseError => 1, AutoCommit => 0 } );
...
my $sth2 = $weberpdb->do("       UPDATE GLTrans SET Posted = 1");
