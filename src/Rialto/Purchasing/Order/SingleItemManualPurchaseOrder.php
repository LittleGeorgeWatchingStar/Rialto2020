 ...
 */
class SingleItemManualPurchaseOrder implements PurchaseInitiator, Item
{
    const INITIATOR_CODE = 'SIPOMANUAL';
    ...
    public function __construct(StockItem $item, Version $version, int $orderQty, PurchasingData $purchasingData)
    {
        $this->item = $item;
        $this->version = $version;
        $this->orderQty = $orderQty;
        $this->purchData = $purchasingData;
    }
