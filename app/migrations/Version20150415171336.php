 ...
 */
class Version20150415171336 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE StockItemFeature ADD featureCode VARCHAR(30) DEFAULT \'\' NOT NULL');
        $this->addSql('ALTER TABLE StockItemFeature ADD CONSTRAINT FK_F3012DC8A47C422A FOREIGN KEY (stockItemId) REFERENCES StockMaster (StockID) ON DELETE CASCADE');
        ...
        foreach ($map as $id => $code) {
            $this->addSql("update StockItemFeature set featureCode = :code where featureId = :id", [
                'code' => $code,
                'id' => $id,
            ]);
        }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE StockItemFeature DROP FOREIGN KEY FK_F3012DC8A47C422A');
        $this->addSql('ALTER TABLE StockItemFeature DROP featureCode');
        $this->addSql('ALTER TABLE StockItemFeature ADD CONSTRAINT FK_F3012DC8A47C422A FOREIGN KEY (stockItemId) REFERENCES StockMaster (StockID)');
    }
}
